        ...
        <div className='flex items-center mt-6 font-medium'>
           <Link to={"/products"} className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-primary-dull
              transition rounded text-white cursor-pointer'>
               Shop Now 
               <img src={assets.white_arrow_icon} alt='arrow'  className='md:hidden transition group-focous : translate-x-1'/>
           </Link>
           <Link to={"/products"} className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>
              Explore Deals
              <img src={assets.black_arrow_icon} alt='arrow'  className=' transition group-hover:translate-x-1 : translate-x-1'/>
            </Link>
        </div>
      </div>
    </div>
